...
#define LNULL NULL /* Valor que representa una posición nula. */

/* Definición de tipos */
typedef struct tNode *tPosL; /* Tipo de dato de las posiciones de la lista, un puntero a un nodo. */
typedef tPosL tList; /* Definición de una lista, un puntero a su primer elemento. */

typedef struct tNode { /* Definición de la estructura que conforma un nodo de la lista. */
    tItemL data; /* Datos de un nodo de la lista. */
    tPosL next; /* Siguiente nodo de la lista en orden. */
} tNode;
